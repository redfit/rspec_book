Feature: code-breaker submits guess
  ...
  that matches the number but not the position of number in the secret code,
  ...
  for each of exact matches in the first, third and fourth positions. The
  ...
  Scenario Outline: submit guess
    ...
    Scenarios: 1 number corrent
      | code | guess | mark |
      | 1234 | 1555  | +    |
      | 1234 | 2555  | -    |

    Scenarios: 2 number corrent
      | code | guess | mark |
      | 1234 | 5254  | ++   |
      | 1234 | 5154  | +-   |
      | 1234 | 2545  | --   |

    Scenarios: 3 number corrent
      | code | guess | mark |
      | 1234 | 5234  | +++  |
      | 1234 | 5134  | ++-  |
      | 1234 | 5124  | +--  |
